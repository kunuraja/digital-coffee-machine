...
public class Espresso implements StandardCoffee {
    ...
    // Identify the required bean units for Espresso
    @Override
    ...
    // Check if sufficient bean units are present to brew Espresso
    @Override
    ...
    // Identify the required milk units for Espresso
    @Override
